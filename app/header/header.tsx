export default function Header() {
  return (
    <header className="relative grid grid-rows-header" style={{ height: '230px' }}>
      ...
      <div className="bg-customRed w-full flex items-center justify-center" style={{ height: '20px' }}>
        <h2 className="text-xs leading-tight" style={{ fontSize: '10px' }}>Comunidad de ayuda para emigrados en Hamburgo</h2>
      </div>
    </header>
  );
}
