      ...
      <div className="max-w-7xl mx-auto">
        <main className="text-center sm:px-10 mb-8 sm:mb-24 mx-2 sm:mx-24">
          ...
          <p className="px-6 text-left py-2 sm:px-24">
            ...
            primero que hay que hacer es registrar el domicilio. El registro o
            en alemán “Anmeldung”* es un trámite que se hace en las oficinas de
            la administración pública del municipio en el que uno va a vivir
          ...
          <p className="px-6 text-left py-2 sm:px-24">
            Este trámite es muy importante es porque es el trámite que activa
            una bola de nieve de procesos administrativos como:
          </p>
          ...
          <p className="px-6 text-left py-2 sm:px-24">
            ...
            te dejan empezar mientras arreglas esos temas de papeles, pero para
            lo que seguro lo vas a necesitar es para que te puedan pagar el
            sueldo.
          </p>
          <p className="px-6 text-left py-2 sm:px-24">
          ...
          <p className="px-6 text-left py-2 sm:px-24">
            ...
            traductor jurado en Alemania) y todas las personas sujetas a
            registro deben comparecer personalmente.”
          </p>
          <p className="px-6 text-left py-2 sm:px-24">
          ...
          <ul className="list-inside py-2 list-disc sm:px-24 text-center">
            ...
            <li className="px-6 text-left">
              Personas divorciadas: sentencia de divorcio jurídicamente
              vinculante (original)
            </li>
            <li className="px-6 text-left">
            ...
            <li className="px-6 text-left">
              Titulares de un permiso de residencia electrónico (eAT): el
          ...
          <ul className="list-inside py-2 list-disc sm:px-24 text-center">
            ...
            <li className="px-6 text-left">
              Un formulario firmado por la persona que te alquila el
              departamento, habitación o lugar donde vivirás, llamado
              &ldquo;Wohnungsgeberbestätigung&ldquo;{" "}
              <a href="https://www.hamburg.de/Dibis/vordr/6700-25-barrierefrei.pdf">
                (descargar formulario)
              </a>
              . Este formulario incluye los datos del lugar de residencia, de
              las personas que se registrarán y de la persona que te alquila o
              aloja.
            </li>
          </ul>
          <p className="px-6 text-left py-2 sm:px-24">
            Si hay niños en la familia, según la página web, se debe presentar
            el certificado de nacimiento en la forma adecuada (certificado
          ...
          <ul className="list-inside py-2 list-disc sm:px-24 text-center">
            ...
            <li className="px-6 text-left">
              Titulares de una tarjeta de residencia electrónica (eAT): la
              tarjeta de residencia.
            </li>
          </ul>
          <p className="px-6 text-left py-2 sm:px-24">
            El costo actual del trámite es de 12 euros. Afortunadamente, en
            Hamburgo, existe una plataforma en línea que permite sacar turno
            para ciertos trámites, incluyendo el empadronamiento. Para solicitar
            turno, debes ingresar aquí:{" "}
          ...
          <ol className="list-inside py-2 list-decimal sm:px-24 text-center">
            ...
            <li className="px-6 text-left">
              Donde aparece el 0, elige la cantidad correspondiente de personas
              (1 para una persona, 2 para dos personas, etc.). Si es tu primera
              vez registrándote en Alemania o en Hamburgo, selecciona la primera
          ...
          <p className="px-6 text-left py-2 sm:px-24">
            Ten en cuenta que el sistema de turnos puede ser aleatorio, por lo
          ...
          <p className="px-6 text-left py-2 sm:px-24">
            ...
            Ummeldung. Si te mudas dentro de Hamburgo, debes seleccionar la
            opción &ldquo;Wohnsitz Ummeldung innerhalb Hamburgs&ldquo; en el
            menú de turnos. El resto del procedimiento es el mismo.
          </p>
          <h4 id="cancelacion" className="text-l font-heading uppercase mt-12">
