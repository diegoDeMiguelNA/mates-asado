...
export default function Datenschutz() {
  return (
    <div className="text-lg mx-4 mt-12 pt-12 flex flex-col px-20">
      ...
      <p>Stand: 3. September 2023</p>
      <h2>Inhaltsübersicht</h2>{" "}
      <ul className="list-disc list-inside mx-auto text-left w-3/4 md:w-1/2">
        <li>
      ...
      <p>
        M&A&apos;s Team
        <br />
        <a href="mailto:mates.asado@gmail.com">mates.asado@gmail.com</a>
      </p>
      Vertretungsberechtigte Personen: <p>Mates y Asado</p>
      E-Mail-Adresse:{" "}
      <p>
        <a href="mailto:mates.asado@gmail.com">mates.asado@gmail.com</a>
      </p>
      Telefon: <p>017650533665</p>
