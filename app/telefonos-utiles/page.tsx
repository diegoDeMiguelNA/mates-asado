  ...
  return (
    <>
      ...
      <main className="text-center sm:px-10 m-8 sm:mb-24 mx-2 sm:mx-24">
        ...
        <div className="py-6 text-xl text">
          <h2 className="text-l sm:text-3xl font-heading uppercase">
          ...
          <h2 className="text-l sm:text-3xl font-heading uppercase mt-12">
            Horario de apertura:
          </h2>
          ...
          <ul className="py-6 px-8 list-inside list-disc sm:px-4 md:px-10 text-center sm:text-left list-none">
            <li>
          ...
          <h2 className="text-l sm:text-3xl font-heading uppercase mt-12 mb-4">
          ...
          <h2 className="text-l sm:text-3xl font-heading uppercase mt-12">Salud</h2>
          <p className="px-8 text-left pt-10 sm:px-24">
          ...
          <h2 className="mt-12 text-l sm:text-3xl font-heading uppercase sm:mt-10 mb-8">
          ...
          <p className="px-8 text-left pt-10 sm:px-24">Veneno llamada al 911</p>
          <p className="px-8 text-left pt-10 sm:px-24">GIZ Norte 0551 19240</p>
          <h2 className="mt-16 px-2text-l sm:text-3xl font-heading uppercase sm:mt-10">
          ...
          <p className="px-8 text-left pt-10 sm:px-24">Urgencias legales: 0171 6105949</p>
          <p className="px-8 text-left pt-10 sm:px-24">
          ...
          <p className="px-8 text-left pt-10 sm:px-24">Jugadores anónimos: 040 2099009</p>
        </div>
        <header className="text-center flex justify-center items-center p-4 sm:p-10">
        <Button>
          <Link href="/">Home</Link>
