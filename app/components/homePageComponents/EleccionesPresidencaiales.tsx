...
export default async function Elecciones() {
  ...
  return (
    <div className="elecciones flex flex-col px-4 md:px-8 justify-center items-center mb-12 md:mb-24 pb-12 md:pb-24 lg:mb-[100px] lg:pt-[90px] bg-light-yellow">
      <div className="relative h-[160px] w-[320px] sm:w-[480px] sm:h-[350px] md:w-[600px] md:h-[350px] lg:w-[850px] rounded-2xl overflow-hidden">
        ...
        <div className="p-4 w-full h-full absolute flex flex-col justify-center items-center">
          <h3 className="text-lg md:text-s lg:text-xl text-yellow font-bold md:mb-4 text-center">
            {subtitle}
          </h3>
          <p
